...
<div class="container mx-auto px-4 py-6 md:py-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 mb-8 md:mb-12">
        ...
        <div class="flex flex-col gap-4 md:gap-6">
            <div class="flex items-start justify-between">
                <div class="flex-1">
                    <h1 class="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white mb-2">{product.title}</h1>
                ...
                <button
                        class="p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors flex-shrink-0 ml-2"
                ...
                >
                    ...
                    {:else}
                        <svg class="w-5 h-5 md:w-6 md:h-6 text-gray-400 dark:text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="mb-8 md:mb-12 w-full overflow-hidden">
        <Tabs.Root value="description" class="w-full">
            <Tabs.List class="border-b border-gray-300 dark:border-gray-700 w-full overflow-x-auto flex">
                <Tabs.Trigger value="description" class="whitespace-nowrap text-gray-900 dark:text-white px-4 py-2">Description</Tabs.Trigger>
                <Tabs.Trigger value="features" class="whitespace-nowrap text-gray-900 dark:text-white px-4 py-2">Features</Tabs.Trigger>
                <Tabs.Trigger value="specifications" class="whitespace-nowrap text-gray-900 dark:text-white px-4 py-2">Specifications</Tabs.Trigger>
                <Tabs.Trigger value="reviews" class="whitespace-nowrap text-gray-900 dark:text-white px-4 py-2">
                    Reviews ({product.reviewCount})
                </Tabs.Trigger>
            </Tabs.List>

            <ScrollArea.Root class="h-64 md:h-80 lg:h-96 rounded-md border border-gray-300 dark:border-gray-700 p-3 md:p-4 dark:bg-gray-800">
                    ...
                    <dl class="divide-y divide-gray-200 dark:divide-gray-700">
                        {#each Object.entries(product.specifications) as [key, value]}
                            <div class="py-3 flex flex-col sm:flex-row sm:justify-between">
                                <dt class="font-medium text-gray-900 dark:text-gray-100 mb-1 sm:mb-0">{key}</dt>
